...
# ========== UPDATED VOICE EXPLANATION SCRIPTS (with pricing & contact) ==========
EXPLANATION_SCRIPT = {
    "English": "Welcome to the System Health AI Monitor, built by Gesner Deslandes, Engineer‑in‑Chief at GlobalInternet.py. This software monitors real‑time system metrics including CPU, memory, disk usage, and network latency. You can switch between Demo mode (simulated data) and Live mode (real metrics from your computer using psutil). It automatically detects anomalies and logs alerts. The AI analyst, powered by Groq's Llama 3.1, provides predictive insights and recommendations. The app also displays detailed system information about your device – device type, brand, model, hostname, operating system, processor, memory, IP addresses, network adapters, and more. A Global Shield API key integration shows your security status. You can adjust refresh rate, enable auto‑refresh, and run AI analysis anytime. The dashboard shows live trends and alerts. To see your own laptop's details, just clone and run the app locally – instructions are in the sidebar. This tool is ideal for platform engineers and software architects to demonstrate observability and AI‑assisted operations. This software is available for purchase – competitive pricing starts at 499 US dollars for a full license, including complete source code and setup support. This software was built by Gesner Deslandes, Engineer‑in‑Chief at GlobalInternet.py. Contact us at (509) 4738 5663 or deslandes78@gmail.com.",
    "French": "Bienvenue dans le Moniteur de santé système en temps réel, conçu par Gesner Deslandes, ingénieur en chef chez GlobalInternet.py. Ce logiciel surveille des métriques système en temps réel : CPU, mémoire, disque et latence réseau. Vous pouvez basculer entre le mode Démo (données simulées) et le mode Direct (métriques réelles de votre ordinateur via psutil). Il détecte automatiquement les anomalies et enregistre des alertes. L'analyste IA, propulsé par le Llama 3.1 de Groq, fournit des analyses prédictives et des recommandations. L'application affiche également des informations détaillées sur votre appareil – type d'appareil, marque, modèle, nom d'hôte, système d'exploitation, processeur, mémoire, adresses IP, adaptateurs réseau, et plus encore. L'intégration de la clé API Global Shield montre votre statut de sécurité. Vous pouvez ajuster la fréquence de rafraîchissement, activer le rafraîchissement automatique et lancer l'analyse IA à tout moment. Le tableau de bord montre les tendances en direct et les alertes. Pour voir les détails de votre propre ordinateur, clonez et exécutez l'application localement – les instructions sont dans la barre latérale. Cet outil est idéal pour les ingénieurs plateforme et les architectes logiciels pour démontrer l'observabilité et les opérations assistées par IA. Ce logiciel est disponible à l'achat – un prix compétitif à partir de 499 dollars américains pour une licence complète, incluant le code source complet et le support d'installation. Ce logiciel a été construit par Gesner Deslandes, ingénieur en chef chez GlobalInternet.py. Contactez-nous au (509) 4738 5663 ou par courriel à deslandes78@gmail.com.",
    "Spanish": "Bienvenido al Monitor de salud del sistema en tiempo real, construido por Gesner Deslandes, ingeniero jefe de GlobalInternet.py. Este software monitorea métricas del sistema en tiempo real: CPU, memoria, uso de disco y latencia de red. Puede cambiar entre el modo Demo (datos simulados) y el modo En vivo (métricas reales de su computadora usando psutil). Detecta automáticamente anomalías y registra alertas. El analista de IA, impulsado por Llama 3.1 de Groq, proporciona información predictiva y recomendaciones. La aplicación también muestra información detallada del sistema – tipo de dispositivo, marca, modelo, nombre del host, sistema operativo, procesador, memoria, direcciones IP, adaptadores de red y más. La integración de la clave API Global Shield muestra su estado de seguridad. Puede ajustar la frecuencia de actualización, habilitar la actualización automática y ejecutar el análisis de IA en cualquier momento. El tablero muestra tendencias en vivo y alertas. Para ver los detalles de su propia computadora, clone y ejecute la aplicación localmente – las instrucciones están en la barra lateral. Esta herramienta es ideal para ingenieros de plataforma y arquitectos de software para demostrar observabilidad y operaciones asistidas por IA. Este software está disponible para la compra – precios competitivos a partir de 499 dólares estadounidenses por una licencia completa, que incluye el código fuente completo y soporte de instalación. Este software fue construido por Gesner Deslandes, ingeniero jefe de GlobalInternet.py. Contáctenos al (509) 4738 5663 o por correo electrónico a deslandes78@gmail.com."
}
